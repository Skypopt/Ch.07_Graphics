...
arcade.start_render()
for y in range(10, 281, 40):
    arcade.draw_line(0, y, 494, y, (191, 10, 48), 20)
arcade.draw_lrtb_rectangle_filled(0, 197.6, 260, 121, (0, 40, 104))
for z in range(142, 260, 30):
    for w in range(33, 165, 31):
        arcade.draw_text("*", w, z, (255, 255, 255), 10)
for z in range(126, 260, 30):
    for x in range(18, 195, 31):
        arcade.draw_text("*", x, z, (255, 255, 255), 10)
